...
// add the layers
// a dense layer is a fully connected layer (every node connects to every other node)
// a unit is a neuron and the number of neurons you decide to use should be the same
// as the number of features that you have, but for this model we're using many
// redundant neurons so as to increase the effeciency of the model.
...
// compiling the model.compile prepares the model for training. you configure the loss and
// optimizer functions in .compile and you can also set the metrics which is an optional parameter
// typically used for metrics (things like accuracy) passed in as an array of strings
...
// pong game code copied from web
